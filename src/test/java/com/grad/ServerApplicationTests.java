...
class ServerApplicationTests {
    ...
    void addPostTest(){
        for(int i = 0;i < 2; i ++){
            postMapper.addPost(new Post(1, 2, 1, "test title", "test content",
...
//        }
    ...
    void addImageTest(){
//        for(int i = 0;i < 5; i ++){
//            imageMapper.addImage(new PostImage(1, 11, i, "https://iso.500px.com/wp-content/uploads/2016/03/stock-photo-142984111-1500x1000.jpg"));
//        }
